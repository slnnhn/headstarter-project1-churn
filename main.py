...
def generate_email(probability, input_dict, explaination, surname):
    ...
    Here is the explanation as to why the customer might be at risk of churning:
    {explaination}
    ...
    Make sure to list out a set of incentives for the customer to stay with the bank based on their information, in bullet point format. Don't ever mention the porbability of churning, or the machine learning model to the customer.
    """
    raw_response = client.chat.completions.create(
